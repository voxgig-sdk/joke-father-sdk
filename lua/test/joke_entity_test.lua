...
describe("JokeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set JOKE_FATHER_TEST_JOKE_ENTID JSON to run live")
      return
    end
...
function joke_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("JOKE_FATHER_TEST_JOKE_ENTID")
  ...
  if env["JOKE_FATHER_TEST_LIVE"] == "TRUE" then
