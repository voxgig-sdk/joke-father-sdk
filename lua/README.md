...
The Lua SDK for the JokeFather API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/joke-father-sdk/releases)),
...
```
lua/
├── joke-father_sdk.lua    -- Main SDK module
...
The main module (`joke-father_sdk`) exports the SDK constructor
