...
local JokeFatherSDK = {}
JokeFatherSDK.__index = JokeFatherSDK
...
JokeFatherSDK._make_feature = _make_feature


function JokeFatherSDK.new(options)
  local self = setmetatable({}, JokeFatherSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function JokeFatherSDK:options_map()
...
function JokeFatherSDK:get_utility()
  return Utility.copy(self._utility)
end


function JokeFatherSDK:get_root_ctx()
  return self._rootctx
end


function JokeFatherSDK:prepare(fetchargs)
...
function JokeFatherSDK:direct(fetchargs)
...
-- by passing it.
function JokeFatherSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function JokeFatherSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "JokeFatherSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function JokeFatherSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = JokeFatherSDK.new(sdkopts)
  sdk.mode = "test"
