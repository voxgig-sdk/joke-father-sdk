...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/joke-father` | `npm install @voxgig-sdk/joke-father` |
| Python | `voxgig-sdk-joke-father` | `pip install voxgig-sdk-joke-father` |
| PHP | `voxgig-sdk/joke-father` | `composer require voxgig-sdk/joke-father` |
| Golang | `github.com/voxgig-sdk/joke-father-sdk/go` | `go get github.com/voxgig-sdk/joke-father-sdk/go` |
| Ruby | `voxgig-sdk-joke-father` | `gem install voxgig-sdk-joke-father` |
| Lua | `voxgig-sdk-joke-father` | `luarocks install voxgig-sdk-joke-father` |
