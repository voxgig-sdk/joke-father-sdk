# JokeFather Golang SDK Reference

Complete API reference for the JokeFather Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *JokeFatherSDK`
...
#### `Joke(data map[string]any) JokeFatherEntity`
