...
class JokeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set JOKEFATHER_TEST_JOKE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def joke_basic_setup(extra)
  ...
  entid_env_raw = ENV["JOKEFATHER_TEST_JOKE_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["JOKEFATHER_TEST_JOKE_ENTID"])
