...
from jokefather_sdk.utility import register

# Load features
from jokefather_sdk.feature.base_feature import JokeFatherBaseFeature
from jokefather_sdk.features import _has_feature, _make_feature
...
class JokeFatherSDK:
    ...
    def get_utility(self):
        return JokeFatherUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JokeFatherSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Joke(self, data=None) -> "JokeEntity":
        ...
        from jokefather_sdk.entity.joke_entity import JokeEntity
        return JokeEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "JokeFatherSDK":
        if sdkopts is None:
            sdkopts = {}
