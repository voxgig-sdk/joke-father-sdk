...
class JokeFatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JokeFatherTestRunner.getenv("JOKEFATHER_TEST_LIVE")
        override = JokeFatherTestRunner.getenv("JOKEFATHER_TEST_OVERRIDE")
        ...
        explain = JokeFatherTestRunner.getenv("JOKEFATHER_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["JOKEFATHER_TEST_EXPLAIN"] = explain
