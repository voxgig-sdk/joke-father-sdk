# JokeFather SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JokeFatherSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JokeFatherSDK(...) and JokeFatherSDK.test(...) become
#      JokeFatherSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "jokefather_sdk"
_SDK_CLASS = "JokeFatherSDK"
