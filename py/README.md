# JokeFather Python SDK



The Python SDK for the JokeFather API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/joke-father-sdk/releases)) or
...
| `joke` | `str` | The complete joke text |
...
```
py/
├── jokefather_sdk.py         -- Main SDK module
