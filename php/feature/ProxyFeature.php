...
class JokeFatherProxyFeature extends JokeFatherBaseFeature
{
    ...
    public function init(JokeFatherContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (JokeFatherContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
