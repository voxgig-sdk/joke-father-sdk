...
// JokeFather SDK ratelimit feature
...
class JokeFatherRatelimitFeature extends JokeFatherBaseFeature
{
    ...
    private function _acquire(JokeFatherContext $ctx): void
    {
    ...
    private function _track(JokeFatherContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
