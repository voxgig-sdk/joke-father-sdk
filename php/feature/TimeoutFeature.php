...
// JokeFather SDK timeout feature
...
class JokeFatherTimeoutFeature extends JokeFatherBaseFeature
{
    ...
    private function _with_timeout(JokeFatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JokeFatherContext $_ctx, float $ms): void
    {
        $client = $this->client;
