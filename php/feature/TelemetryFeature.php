...
// JokeFather SDK telemetry feature
...
class JokeFatherTelemetryFeature extends JokeFatherBaseFeature
{
    ...
    private function _close(JokeFatherContext $ctx, bool $ok): void
    {
