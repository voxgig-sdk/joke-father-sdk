...
class JokeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set JOKE_FATHER_TEST_JOKE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function joke_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("JOKE_FATHER_TEST_JOKE_ENTID");
    ...
    if ($env["JOKE_FATHER_TEST_LIVE"] === "TRUE") {
        ...
        $client = new JokeFatherSDK(Helpers::to_map($merged_opts));
    }
