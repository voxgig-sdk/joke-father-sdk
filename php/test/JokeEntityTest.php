...
class JokeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set JOKEFATHER_TEST_JOKE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function joke_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("JOKEFATHER_TEST_JOKE_ENTID");
