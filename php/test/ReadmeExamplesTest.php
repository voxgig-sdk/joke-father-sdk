...
// JokeFather SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JokeFatherSDK::test)
...
{
    private const SDK_CLASS = 'JokeFatherSDK';
    ...
    private const SDK_BASE = 'jokefather_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../jokefather_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
