...
class JokeFatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JokeFatherTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = JokeFatherTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = JokeFatherTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
