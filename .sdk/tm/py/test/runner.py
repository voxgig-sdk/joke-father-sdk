...
class JokeFatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = JokeFatherTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = JokeFatherTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = JokeFatherTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
