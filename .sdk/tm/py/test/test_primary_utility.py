...
from projectname_sdk import JokeFatherSDK
from projectname_sdk.core.spec import JokeFatherSpec
from projectname_sdk.core.result import JokeFatherResult
from projectname_sdk.core.response import JokeFatherResponse
from projectname_sdk.core.operation import JokeFatherOperation
from projectname_sdk.core.error import JokeFatherError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import JokeFatherBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return JokeFatherError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = JokeFatherSDK.test(None, None)
        ...
        class TestInitFeature(JokeFatherBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(JokeFatherBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = JokeFatherSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = JokeFatherSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = JokeFatherSDK.test(None, setup_opts)
