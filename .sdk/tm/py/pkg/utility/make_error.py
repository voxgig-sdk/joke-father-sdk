# JokeFather SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, JokeFatherError):
        errmsg = err.msg
    ...
    msg = "JokeFatherSDK: " + opname + ": " + errmsg
    ...
    sdk_err = JokeFatherError("", msg, ctx)
