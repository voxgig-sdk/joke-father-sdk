...
from projectname_sdk.core.control import JokeFatherControl
...
class JokeFatherContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, JokeFatherSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, JokeFatherResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, JokeFatherResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return JokeFatherError(code, msg, self)
