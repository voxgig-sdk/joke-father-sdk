...
// JokeFather SDK utility: graphql
//
...
class JokeFatherGraphql
{
    ...
    // equivalent.
    public static function body(JokeFatherContext $ctx): mixed
    {
    ...
    public static function errors(JokeFatherContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
