...
// JokeFather SDK utility: fetcher

class JokeFatherFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JokeFatherSDK/1.0)';
    ...
    public static function call(JokeFatherContext $ctx, string $fullurl, array $fetchdef): array
    {
