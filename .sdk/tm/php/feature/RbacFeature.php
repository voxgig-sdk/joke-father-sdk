...
class JokeFatherRbacFeature extends JokeFatherBaseFeature
{
    ...
    private function _required(JokeFatherContext $ctx): ?string
    {
    ...
    private function _reject(JokeFatherContext $ctx, string $required): void
    {
    ...
    private function _track(JokeFatherContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
