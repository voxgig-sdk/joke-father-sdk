...
class JokeFatherCacheFeature extends JokeFatherBaseFeature
{
    ...
    private function _through(JokeFatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
