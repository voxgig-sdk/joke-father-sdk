...
// JokeFather SDK streaming feature
...
class JokeFatherStreamingFeature extends JokeFatherBaseFeature
{
    ...
    private function _iterate(JokeFatherResult $result): \Generator
    {
    ...
    private function _streamable(JokeFatherContext $ctx): bool
    {
