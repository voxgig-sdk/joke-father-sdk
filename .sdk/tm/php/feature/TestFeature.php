...
// JokeFather SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class JokeFatherTestFeature extends JokeFatherBaseFeature
{
    ...
    public function init(JokeFatherContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (JokeFatherContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = JokeFatherParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (JokeFatherContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(JokeFatherContext $ctx, $op, $args): array
    {
