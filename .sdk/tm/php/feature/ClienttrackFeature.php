...
// JokeFather SDK clienttrack feature
...
class JokeFatherClienttrackFeature extends JokeFatherBaseFeature
{
    ...
    public function PostConstruct(JokeFatherContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'JokeFather-SDK';
