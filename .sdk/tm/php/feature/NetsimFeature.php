...
class JokeFatherNetsimFeature extends JokeFatherBaseFeature
{
    ...
    private function _simulate(JokeFatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(JokeFatherContext $ctx, array $applied): void
    {
        $client = $this->client;
