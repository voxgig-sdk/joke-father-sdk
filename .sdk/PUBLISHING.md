...
|---|---|---|
| `ts/` | @voxgig-sdk/joke-father-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/joke-father-sdk \
      --repository voxgig-sdk/joke-father-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/joke-father-sdk` shows it, and
`npm trust revoke @voxgig-sdk/joke-father-sdk --id=<id>` removes it.
