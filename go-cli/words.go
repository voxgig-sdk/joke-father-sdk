...
func registerSDKWords(r *eng.Registry, client *sdk.JokeFatherSDK) {
...
func runOp(client *sdk.JokeFatherSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
