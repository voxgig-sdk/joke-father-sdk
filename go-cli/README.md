...
AQL-driven CLI and REPL for the JokeFather SDK. Positional arguments are
...
./joke-father-cli list joke
./joke-father-cli load 1 joke
./joke-father-cli load '{id:1}' joke
