# JokeFather TypeScript SDK



The TypeScript SDK for the JokeFather API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/joke-father-sdk/releases](https://github.com/voxgig-sdk/joke-father-sdk/releases)
...
```ts
import { JokeFatherSDK } from '@voxgig-sdk/joke-father-sdk'
...
| `tester(testopts?, sdkopts?)` | `JokeFatherSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `JokeFatherSDK.test(testopts?, sdkopts?)` | `JokeFatherSDK` | Create a test-mode client. |
...
| `client` | `client(): JokeFatherSDK` | Return the parent SDK client. |
...
joke-father/
├── src/
│   ├── JokeFatherSDK.ts        # Main SDK class
