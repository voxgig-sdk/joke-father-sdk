...
function envOverride(m) {
    if ('TRUE' === process.env.JOKE_FATHER_TEST_LIVE ||
        'TRUE' === process.env.JOKE_FATHER_TEST_OVERRIDE) {
    ...
    m.JOKE_FATHER_TEST_EXPLAIN = process.env.JOKE_FATHER_TEST_EXPLAIN || m.JOKE_FATHER_TEST_EXPLAIN;
    return m;
}
