...
(0, node_test_1.describe)('JokeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.JokeFatherSDK({
...
function liveScenariosActive() { return false && process.env.JOKE_FATHER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.JokeFatherSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['JOKE_FATHER_TEST_JOKE_ENTID'];
    ...
    const client = new __1.JokeFatherSDK({
        base: 'http://localhost:8080',
