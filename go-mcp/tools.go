...
func registerTools(server *mcp.Server, client *sdk.JokeFatherSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "joke-father_list",
		Description: "List records from JokeFather. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "joke-father_load",
		Description: "Load a single record from JokeFather. " +
...
func runOp(client *sdk.JokeFatherSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JokeFatherSDK, name string) (sdk.JokeFatherEntity, error) {
