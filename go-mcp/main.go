// Command JokeFather-mcp is an MCP server exposing the JokeFather
// SDK as MCP tools.
//
// Two tools are registered:
//
//	JokeFather_list  — list records of an entity
//	JokeFather_load  — load a single record of an entity
//
